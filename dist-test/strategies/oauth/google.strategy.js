...
let GoogleAuthStrategy = class GoogleAuthStrategy {
    ...
    async registerCredentials(dto, uid) {
        ...
        return { auth: await this.authRepo.save(newAuth), identifier: (_b = newAuth.identifiers) === null || _b === void 0 ? void 0 : _b[0] };
    }
    async login(dto) {
        ...
        oauthProvider.displayName = (_b = payload.name) !== null && _b !== void 0 ? _b : null;
        oauthProvider.avatarUrl = (_c = payload.picture) !== null && _c !== void 0 ? _c : null;
        oauthProvider.emailVerified = (_d = payload.email_verified) !== null && _d !== void 0 ? _d : false;
        auth.lastUsedAt = new Date();
        let identifier = null;
        if (email) {
            const idResult = await this.identifierRepo.findWithAuthByValue(email);
            identifier = (idResult === null || idResult === void 0 ? void 0 : idResult.identifier) || null;
            if (!identifier || ((_e = identifier.auth) === null || _e === void 0 ? void 0 : _e.id) !== auth.id) {
            ...
            if (!this.options.forceVerificationOnGoogleLogin) {
                identifier.isVerified = (_f = payload.email_verified) !== null && _f !== void 0 ? _f : false;
            }
        ...
        const updatedIdentifier = ((_g = updatedAuth === null || updatedAuth === void 0 ? void 0 : updatedAuth.identifiers) === null || _g === void 0 ? void 0 : _g.find((i) => i.type === identifier_type_enum_1.IdentifierType.EMAIL && i.value === email)) || identifier;
        return {
