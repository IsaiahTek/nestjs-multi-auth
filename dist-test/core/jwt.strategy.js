...
let JwtStrategy = JwtStrategy_1 = class JwtStrategy extends (0, passport_1.PassportStrategy)(passport_jwt_1.Strategy) {
    constructor(options, authService, cookieService) {
        const cookieExtractor = (req) => {
            ...
            if (!(cookieConfig === null || cookieConfig === void 0 ? void 0 : cookieConfig.accessTokenName))
                return null;
            const token = cookies === null || cookies === void 0 ? void 0 : cookies[cookieConfig.accessTokenName];
